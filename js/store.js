...
(function () {
  ...
  const I18N = {
    en: {
      ...
      filter_type: 'Mission type', col_loc: 'Location', col_type: 'Type', col_eff: 'Relic chance / run',
      col_gets: 'Relics that drop here', col_runs: 'avg runs', via: 'gives', rotation: 'Rot.',
      ...
      note: 'Relic chance/run = chance to get one of your needed relics per mission reward. Where several needed relics drop at the same spot, their chances are summed. avg runs = rewards until your first needed relic. (Crack the relics afterwards to get the parts.)',
    ...
    ru: {
      ...
      filter_type: 'Тип миссии', col_loc: 'Локация', col_type: 'Тип', col_eff: 'Шанс реликвии / заход',
      col_gets: 'Какие реликвии тут падают', col_runs: 'заходов', via: 'даёт', rotation: 'Рот.',
      ...
      note: 'Шанс реликвии/заход — шанс выбить одну из нужных реликвий за одну награду миссии. Где несколько нужных реликвий падают в одном месте — их шансы складываются. Заходов — наград до первой нужной реликвии. (Сами детали потом выбиваются вскрытием реликвий.)',
  ...
  document.addEventListener('alpine:init', () => {
    window.Alpine.store('wf', {
      ...
      get locsAll() { return window.WFCalc.rankLocations(this.data, this.selected, null); },
      get locations() { return window.WFCalc.rankLocations(this.data, this.selected, this.typeSel); },
